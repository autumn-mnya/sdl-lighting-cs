# SDL2 Lighting Mod
This is an addon to the SDL2 dll that adds Lighting into freeware Cave Story.

See the data/lightdefs.txt file in order to customize lighting for entities, the player, etc.
